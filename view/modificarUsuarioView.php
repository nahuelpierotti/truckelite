...
<div class="w3-display-container">
    <div id="formularioUsuario" name="formularioUsuario" class="w3-container w3-content w3-card-4 w3-padding"
        ...
        <form class="" action="modificarUsuario/modificarUsuario" method="post">
            ...
            <p>
                ...
                <input class="w3-input w3-border w3-sand" name="idUsuario" type="text"
                       value="{{usuarioBuscado.0.id_usuario}}">
