    ...
    <div id="formularioMantenimiento" class="w3-container w3-content w3-card-4 w3-padding" style="margin-bottom: 4em;margin-top: 6em;">
        ...
        <form class="" action="mantenimiento/agregarMantenimiento" method="post">
            ...
            <p>
                ...
                <input class="w3-input w3-border w3-sand" name="kmUnidad" type="number" min="0" value="">

            </p>

            <p>
                <label class="w3-text-brown"><b>Costo</b></label>
                <input class="w3-input w3-border w3-sand" name="costo" type="number" min="0" value="">
            ...
            <p>
                ...
                <input class="w3-input w3-border w3-sand" name="dniMecanico" type="number" min="0" value="">
            ...
            <p>
                ...
                <input class="w3-input w3-border w3-sand" name="patente_vehiculo" type="text" value="">
