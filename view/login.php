{{> header}}
<section class="w3-display-container imgLogin">
    <form action="usuario/validar" method="POST"
          class="w3-display-topmiddle w3-padding w3-card w3-white  w3-border w3-round w3-mobile" style="width:40%; margin-top: 12em">
            <div class="w3-center w3-padding-16">
                <img src="view/img/user.svg" style="width: 20%;">
            </div>
            <label for="" class="lbl-nombre">Usuario</label>
            <input type="text" name="usuario" class="w3-input form-input-login" required>
            <label for="">Clave</label>
            <input type="password" name="clave" class="w3-input form-input-login" required>
